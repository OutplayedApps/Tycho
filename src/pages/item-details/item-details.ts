...
export class ItemDetailsPage {
  ...
  getFile() {
    ...
    url = 'https://www.googleapis.com/drive/v3/files/fileId/export?fileId=1K7rh9iKomflEKEs5ApstHQM9vvNV73UIY8j3LA_rcpU&mimeType=text/html&key=AIzaSyDIzqeDtau8sP6OtsURRSsSjUxDR1Qd1RA';
